...
#ifndef FCOE_LOCAL_FCOE_MAPMESSAGE_H
#define FCOE_LOCAL_FCOE_MAPMESSAGE_H
...
namespace DcmNs
{
    ...
    class FcoeLocalFcoeMapMessage : public PrismMessage
    {
        private:
        protected:
        ...
        public:
            ...
            FcoeLocalFcoeMapMessage (const UI32 &oper_bmp,const string &map_name,const string &fabric_map_name,const string &cee_map_name);
            virtual    ~FcoeLocalFcoeMapMessage ();
...
#endif                                            //FCOE_LOCAL_FCOE_MAPMESSAGE_H
