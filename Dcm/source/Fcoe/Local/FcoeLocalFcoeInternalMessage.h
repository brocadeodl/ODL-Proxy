...
#ifndef FCOE_LOCAL_FCOE_INTERNAL_MESSAGE_H
#define FCOE_LOCAL_FCOE_INTERNAL_MESSAGE_H
...
{   
    ...
    class FcoeLocalFcoeInternalMessage : public PrismMessage
    {   
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            FcoeLocalFcoeInternalMessage ();
            FcoeLocalFcoeInternalMessage (const UI32 &cmd_code);
            virtual    ~FcoeLocalFcoeInternalMessage ();
