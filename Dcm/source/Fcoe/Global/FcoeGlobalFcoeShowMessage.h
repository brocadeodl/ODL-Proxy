...
#ifndef FCOE_GLOBAL_FCOE_SHOW_MESSAGE_H
#define FCOE_GLOBAL_FCOE_SHOW_MESSAGE_H
...
namespace DcmNs
{
    ...
    class FcoeGlobalFcoeShowMessage : public ManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            FcoeGlobalFcoeShowMessage ();
            FcoeGlobalFcoeShowMessage (const UI32 &cmd_code);
            virtual    ~FcoeGlobalFcoeShowMessage ();
...
#endif                                            //FCOE_GLOBAL_FCOE_SHOW_MESSAGE_H
