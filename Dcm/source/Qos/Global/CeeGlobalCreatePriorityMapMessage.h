...
#ifndef CEEGLOBALCREATEPRIORITYMAPMESSAGE_H
#define CEEGLOBALCREATEPRIORITYMAPMESSAGE_H
...
namespace DcmNs
{
    ...
    class CeeGlobalCreatePriorityMapMessage : public ManagementInterfaceMessage
    {
        private:
        protected:
        ...
        public:
            ...
            CeeGlobalCreatePriorityMapMessage (const string &ceeMapName,const string &cos0ToPriorityGrouMap,const string &cos1ToPriorityGrouMap,const string &cos2ToPriorityGrouMap,const string &cos3ToPriorityGrouMap,const string &cos4ToPriorityGrouMap,const string &cos5ToPriorityGrouMap,const string &cos6ToPriorityGrouMap,const string &cos7ToPriorityGrouMap);
            virtual    ~CeeGlobalCreatePriorityMapMessage ();
...
#endif                                            //CEEGLOBALCREATEPRIORITYMAPMESSAGE_H
