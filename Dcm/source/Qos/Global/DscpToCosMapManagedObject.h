...
#ifndef DSCPTOCOSMAPMANAGEDOBJECT_H
#define DSCPTOCOSMAPMANAGEDOBJECT_H
...
namespace DcmNs
{
    ...
    class DscpToCosMapManagedObject : virtual public DcmManagedObject
    {
        private:
        protected:
        ...
        public:
            DscpToCosMapManagedObject (QosGlobalObjectManager *pQosGlobalObjectManager);
            DscpToCosMapManagedObject (QosGlobalObjectManager *pQosGlobalObjectManager,const string &dscpToCosMapName,const vector<WaveManagedObjectPointer<DscpMarkListManagedObject> > &dscpMarkList);
            virtual    ~DscpToCosMapManagedObject ();
...
#endif                                            //DSCPTOCOSMAPMANAGEDOBJECT_H
