...
#ifndef QOSRCVQUEUEMULTICASTSETTINGMANAGEDOBJECT_H
#define QOSRCVQUEUEMULTICASTSETTINGMANAGEDOBJECT_H
...
namespace DcmNs
{
    ...
    class QosRcvQueueMulticastSettingManagedObject : virtual public DcmManagedObject
    {
        private:
        protected:
        ...
        public:
            QosRcvQueueMulticastSettingManagedObject (QosGlobalObjectManager *pQosGlobalObjectManager);
            QosRcvQueueMulticastSettingManagedObject (QosGlobalObjectManager *pQosGlobalObjectManager,const SI32 &rateLimit,const SI32 &burst,const SI32 &thresholdTrafficClass0,const SI32 &thresholdTrafficClass1,const SI32 &thresholdTrafficClass2,const SI32 &thresholdTrafficClass3, const SI32 &thresholdTrafficClass4,const SI32 &thresholdTrafficClass5,const SI32 &thresholdTrafficClass6,const SI32 &thresholdTrafficClass7);
            virtual    ~QosRcvQueueMulticastSettingManagedObject ();
...
#endif                                            //QOSRCVQUEUEMULTICASTSETTINGMANAGEDOBJECT_H
