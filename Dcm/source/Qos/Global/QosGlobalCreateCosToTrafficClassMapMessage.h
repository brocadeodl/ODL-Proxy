...
#ifndef QOSGLOBALCREATECOSTOTRAFFICCLASSMAPMESSAGE_H
#define QOSGLOBALCREATECOSTOTRAFFICCLASSMAPMESSAGE_H
...
namespace DcmNs
{
    ...
    class QosGlobalCreateCosToTrafficClassMapMessage : public ManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            QosGlobalCreateCosToTrafficClassMapMessage ();
            QosGlobalCreateCosToTrafficClassMapMessage (const string &cosToTrafficClassMapName,const SI32 &cos0MappedTrafficClassValue,const SI32 &cos1MappedTrafficClassValue,const SI32 &cos2MappedTrafficClassValue,const SI32 &cos3MappedTrafficClassValue,const SI32 &cos4MappedTrafficClassValue,const SI32 &cos5MappedTrafficClassValue,const SI32 &cos6MappedTrafficClassValue,const SI32 &cos7MappedTrafficClassValue);
            virtual    ~QosGlobalCreateCosToTrafficClassMapMessage ();
...
#endif                                            //QOSGLOBALCREATECOSTOTRAFFICCLASSMAPMESSAGE_H
