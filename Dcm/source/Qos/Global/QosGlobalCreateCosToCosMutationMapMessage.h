...
#ifndef QOSGLOBALCREATECOSTOCOSMUTATIONMAPMESSAGE_H
#define QOSGLOBALCREATECOSTOCOSMUTATIONMAPMESSAGE_H
...
namespace DcmNs
{
    ...
    class QosGlobalCreateCosToCosMutationMapMessage : public ManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            QosGlobalCreateCosToCosMutationMapMessage ();
            QosGlobalCreateCosToCosMutationMapMessage (const string &cosToCosMutationMapName,const SI32 &cos0MutatedCosValue,const SI32 &cos1MutatedCosValue,const SI32 &cos2MutatedCosValue,const SI32 &cos3MutatedCosValue,const SI32 &cos4MutatedCosValue,const SI32 &cos5MutatedCosValue,const SI32 &cos6MutatedCosValue,const SI32 &cos7MutatedCosValue);
            virtual    ~QosGlobalCreateCosToCosMutationMapMessage ();
...
#endif                                            //QOSGLOBALCREATECOSTOCOSMUTATIONMAPMESSAGE_H
