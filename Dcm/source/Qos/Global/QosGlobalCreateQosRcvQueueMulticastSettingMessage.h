...
#ifndef QOSGLOBALCREATEQOSRCVQUEUEMULTICASTSETTINGMESSAGE_H
#define QOSGLOBALCREATEQOSRCVQUEUEMULTICASTSETTINGMESSAGE_H
...
namespace DcmNs
{
    ...
    class QosGlobalCreateQosRcvQueueMulticastSettingMessage : public ManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            QosGlobalCreateQosRcvQueueMulticastSettingMessage ();
            QosGlobalCreateQosRcvQueueMulticastSettingMessage (const SI32 &rateLimit,const SI32 &burst,const SI32
				&thresholdTrafficClass0,const SI32 &thresholdTrafficClass1,const SI32 &thresholdTrafficClass2,const SI32 &thresholdTrafficClass3, const SI32 &thresholdTrafficClass4,const SI32 &thresholdTrafficClass5,const SI32 &thresholdTrafficClass6,const SI32 &thresholdTrafficClass7, const SI32 &opCode);
            virtual    ~QosGlobalCreateQosRcvQueueMulticastSettingMessage ();
...
#endif                                            //QOSGLOBALCREATEQOSRCVQUEUEMULTICASTSETTINGMESSAGE_H
