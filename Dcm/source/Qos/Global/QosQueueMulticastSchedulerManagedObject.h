...
#ifndef QOSQUEUEMULTICASTSCHEDULERMANAGEDOBJECT_H
#define QOSQUEUEMULTICASTSCHEDULERMANAGEDOBJECT_H
...
namespace DcmNs
{
    ...
    class QosQueueMulticastSchedulerManagedObject : virtual public DcmManagedObject
    {
        private:
        protected:
        ...
        public:
            QosQueueMulticastSchedulerManagedObject (QosGlobalObjectManager *pQosGlobalObjectManager);
            QosQueueMulticastSchedulerManagedObject (QosGlobalObjectManager *pQosGlobalObjectManager,const SI32 &dwrrTrafficClass0,const SI32 &dwrrTrafficClass1,const SI32 &dwrrTrafficClass2,const SI32 &dwrrTrafficClass3,const SI32 &dwrrTrafficClass4,const SI32 &dwrrTrafficClass5,const SI32 &dwrrTrafficClass6,const SI32 &dwrrTrafficClass7);
            virtual    ~QosQueueMulticastSchedulerManagedObject ();
...
#endif                                            //QOSQUEUEMULTICASTSCHEDULERMANAGEDOBJECT_H
