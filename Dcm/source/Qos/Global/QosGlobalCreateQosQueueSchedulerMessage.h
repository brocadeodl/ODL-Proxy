...
#ifndef QOSGLOBALCREATEQOSQUEUESCHEDULERMESSAGE_H
#define QOSGLOBALCREATEQOSQUEUESCHEDULERMESSAGE_H
...
namespace DcmNs
{
    ...
    class QosGlobalCreateQosQueueSchedulerMessage : public ManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            QosGlobalCreateQosQueueSchedulerMessage ();
            QosGlobalCreateQosQueueSchedulerMessage (const SI32 &strictPriority,const SI32 &dwrrTrafficClass0,const SI32 &dwrrTrafficClass1,const SI32 &dwrrTrafficClass2,const SI32 &dwrrTrafficClass3,const SI32 &dwrrTrafficClass4,const SI32 &dwrrTrafficClass5,const SI32 &dwrrTrafficClass6,const SI32 &dwrrTrafficClass7);
            virtual    ~QosGlobalCreateQosQueueSchedulerMessage ();
...
#endif                                            //QOSGLOBALCREATEQOSQUEUESCHEDULERMESSAGE_H
