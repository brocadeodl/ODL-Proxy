...
#ifndef COSTOTRAFFICCLASSMAPMANAGEDOBJECT_H
#define COSTOTRAFFICCLASSMAPMANAGEDOBJECT_H
...
namespace DcmNs
{
    ...
    class CosToTrafficClassMapManagedObject : virtual public DcmManagedObject
    {
        private:
        protected:
        ...
        public:
            CosToTrafficClassMapManagedObject (QosGlobalObjectManager *pQosGlobalObjectManager);
            CosToTrafficClassMapManagedObject (QosGlobalObjectManager *pQosGlobalObjectManager,const string &cosToTrafficClassMapName,const SI32 &cos0MappedTrafficClassValue,const SI32 &cos1MappedTrafficClassValue,const SI32 &cos2MappedTrafficClassValue,const SI32 &cos3MappedTrafficClassValue,const SI32 &cos4MappedTrafficClassValue,const SI32 &cos5MappedTrafficClassValue,const SI32 &cos6MappedTrafficClassValue,const SI32 &cos7MappedTrafficClassValue);
            virtual    ~CosToTrafficClassMapManagedObject ();
...
#endif                                            //COSTOTRAFFICCLASSMAPMANAGEDOBJECT_H
