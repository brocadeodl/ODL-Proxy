...
#ifndef QOSGLOBALCREATEQOSQUEUEMULTICASTSCHEDULERMESSAGE_H
#define QOSGLOBALCREATEQOSQUEUEMULTICASTSCHEDULERMESSAGE_H
...
namespace DcmNs
{
    ...
    class QosGlobalCreateQosQueueMulticastSchedulerMessage : public ManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            QosGlobalCreateQosQueueMulticastSchedulerMessage ();
            QosGlobalCreateQosQueueMulticastSchedulerMessage (const SI32 &dwrrTrafficClass0,const SI32 &dwrrTrafficClass1,const SI32 &dwrrTrafficClass2,const SI32 &dwrrTrafficClass3,const SI32 &dwrrTrafficClass4,const SI32 &dwrrTrafficClass5,const SI32 &dwrrTrafficClass6,const SI32 &dwrrTrafficClass7);
            virtual    ~QosGlobalCreateQosQueueMulticastSchedulerMessage ();
...
#endif                                            //QOSGLOBALCREATEQOSQUEUEMULTICASTSCHEDULERMESSAGE_H
