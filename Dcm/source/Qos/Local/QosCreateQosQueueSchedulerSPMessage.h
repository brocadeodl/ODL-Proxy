...
#ifndef QOSCREATEQOSQUEUESCHEDULERSPMESSAGE_H
#define QOSCREATEQOSQUEUESCHEDULERSPMESSAGE_H
...
namespace DcmNs
{
    ...
    class QosCreateQosQueueSchedulerSPMessage : public PrismMessage 
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            QosCreateQosQueueSchedulerSPMessage ();
            QosCreateQosQueueSchedulerSPMessage (const SI32 &strictPriority,const SI32 &dwrrTrafficClass0,const SI32 &dwrrTrafficClass1,const SI32 &dwrrTrafficClass2,const SI32 &dwrrTrafficClass3,const SI32 &dwrrTrafficClass4,const SI32 &dwrrTrafficClass5,const SI32 &dwrrTrafficClass6,const SI32 &dwrrTrafficClass7);
            virtual    ~QosCreateQosQueueSchedulerSPMessage ();
...
#endif                                            //QOSCREATEQOSQUEUESCHEDULERSPMESSAGE_H
