...
#ifndef QOSDELETEQOSPHYINTFCONFIGMESSAGE_H
#define QOSDELETEQOSPHYINTFCONFIGMESSAGE_H
...
namespace DcmNs
{
    ...
    class QosDeleteQosPhyIntfConfigMessage : public ManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            QosDeleteQosPhyIntfConfigMessage ();
            QosDeleteQosPhyIntfConfigMessage (const string &ifName,const UI64 &ifIndex,const string &id,const string &cosToCosMutationMapName,const string &CosToTrafficClassMapName,const string &ceeMapName,const SI32 &flowControlTxEnable,const SI32 &flowControlRxEnable,const SI32 &flowControlPfcCosValue,const SI32 &defaultCosValue,const string &qosTrust,const SI32 &opCode);
            virtual    ~QosDeleteQosPhyIntfConfigMessage ();
...
#endif                                            //QOSDELETEQOSPHYINTFCONFIGMESSAGE_H
