...
#ifndef QOSCREATECOSTOCOSMUTATIONMAPSPMESSAGE_H
#define QOSCREATECOSTOCOSMUTATIONMAPSPMESSAGE_H
...
namespace DcmNs
{
    ...
    class QosCreateCosToCosMutationMapSPMessage : public PrismMessage
    {
        private:
        protected:
        ...
        public:
            ...
            virtual    ~QosCreateCosToCosMutationMapSPMessage ();
...
#endif                                            //QOSCREATECOSTOCOSMUTATIONMAPMESSAGE_H
