...
#ifndef INTERFACEDATATYPELOCALMANAGEDOBJECT_H
#define INTERFACEDATATYPELOCALMANAGEDOBJECT_H
...
namespace DcmNs
{
    ...
    class InterfaceDataTypeLocalManagedObject : virtual public DcmLocalManagedObject
    {
        private:
        protected:
        ...
        public:
            InterfaceDataTypeLocalManagedObject (WaveObjectManager *pWaveObjectManager);
            virtual     ~InterfaceDataTypeLocalManagedObject ();
            ...
            void        setUtype(const WaveUnion &val); // this sets the type which is used inside union
...
#endif                                            //INTERFACEDATATYPELOCALMANAGEDOBJECT_H
