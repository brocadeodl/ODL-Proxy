...
#ifndef OSPFPERMITDENYREDISTRIBUTELOCALMESSAGE_H
#define OSPFPERMITDENYREDISTRIBUTELOCALMESSAGE_H
...
namespace DcmNs
{
    ...
    class OSPFPermitDenyRedistributeLocalMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            OSPFPermitDenyRedistributeLocalMessage ();
            OSPFPermitDenyRedistributeLocalMessage (const UI8 &opCode,const UI8 &cmdCode,const UI32 &index, const OSPFPermitDenyOption &permitDenyOption, const OSPFRouteOption &routeOption, const IpV4Address &subNet, const IpV4Address &mask, const UI32 &matchMetric, const UI32 &setMetric);
            virtual    ~OSPFPermitDenyRedistributeLocalMessage ();
...
#endif                                            //OSPFPermitDenyRedistributeLocalMessage_H
