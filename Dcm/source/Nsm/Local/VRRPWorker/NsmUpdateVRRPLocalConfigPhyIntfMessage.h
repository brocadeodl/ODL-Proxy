...
#ifndef NSMUPDATEVRRPLOCALCONFIGPHYINTFMESSAGE_H
#define NSMUPDATEVRRPLOCALCONFIGPHYINTFMESSAGE_H
...
#define NSMUPDATEVRRPLOCALCONFIGPHYINTF 2

namespace DcmNs
{

    class NsmUpdateVRRPLocalConfigPhyIntfMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            NsmUpdateVRRPLocalConfigPhyIntfMessage ();
        NsmUpdateVRRPLocalConfigPhyIntfMessage (const string &ifName,const InterfaceType &ifType,const UI8 &vrid,const IpV4Address &virtual_ip,const InterfaceType &track_ifType,const string &track_ifName,const UI8 &track_prio,const UI32 &advt_int,const UI8 &prio,const bool &enable,const bool &preempt,const UI32 &hold_time,const string &description,const bool &advt_backup,const UI32 &garp_timer,const UI32 &backup_advt_int,const bool &spf,const UI8 &rev_prio,const UI8 &vrrp_type,const UI32 &choice,const UI32 &op_type);
            virtual    ~NsmUpdateVRRPLocalConfigPhyIntfMessage ();
            ...
            void setOp_type(const UI32 &op_type);
            UI32 getOp_type()  const;
...
#endif                                            //NSMUPDATEVRRPLOCALCONFIGPHYINTFMESSAGE_H
