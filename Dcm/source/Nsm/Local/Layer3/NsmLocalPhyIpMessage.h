...
#ifndef NsmLocalPhyIpMessage_H
#define NsmLocalPhyIpMessage_H
...
namespace DcmNs
{
    class NsmLocalPhyIpMessage : public PrismMessage 
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            NsmLocalPhyIpMessage ();
            virtual  ~NsmLocalPhyIpMessage ();
