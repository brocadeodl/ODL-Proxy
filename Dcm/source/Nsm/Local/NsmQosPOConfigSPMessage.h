...
#ifndef NSMQOSPOCONFIGSPMESSAGE_H
#define NSMQOSPOCONFIGSPMESSAGE_H
...
namespace DcmNs
{
    ...
    class NsmQosPOConfigSPMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            NsmQosPOConfigSPMessage ();
            NsmQosPOConfigSPMessage (const UI32 &poId,const UI32 &flowControlTx,const UI32 &flowControlRx,const bool &qosTrust,const bool &qosDscpTrust, const SI32 &defaultCosValue,const SI32 &cmdCode,const SI32 &OpCode, const string &qosPolicyMapName);
            virtual    ~NsmQosPOConfigSPMessage ();
...
#endif                                            //NSMQOSPOCONFIGSPMESSAGE_H
