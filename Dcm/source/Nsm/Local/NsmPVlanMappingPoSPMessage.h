...
#ifndef NSMPVLANMAPPINGPOSPMESSAGE_H
#define NSMPVLANMAPPINGPOSPMESSAGE_H
...
namespace DcmNs
{
    ...
    class NsmPVlanMappingPoSPMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            NsmPVlanMappingPoSPMessage ();
            NsmPVlanMappingPoSPMessage (const string &ifName,const UI32 &primaryVlanId,const UI32Range &secVlanRange, const  UI32 &oper, const UI32 &opcode);
            virtual    ~NsmPVlanMappingPoSPMessage ();
