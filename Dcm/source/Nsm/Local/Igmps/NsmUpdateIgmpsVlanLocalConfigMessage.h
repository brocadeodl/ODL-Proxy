...
#ifndef NSMUPDATEIGMPSVLANLOCALCONFIGMESSAGE_H
#define NSMUPDATEIGMPSVLANLOCALCONFIGMESSAGE_H
...
namespace DcmNs
{
    ...
    class NsmUpdateIgmpsVlanLocalConfigMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            NsmUpdateIgmpsVlanLocalConfigMessage ();
            NsmUpdateIgmpsVlanLocalConfigMessage (const UI32 &lmqi,const UI32 &qmrt,const bool &enable,const bool &fastLeave,const UI32 &queryInterval,const bool &querierEnable,const UI32 &mrouterTimeout,const UI32 &vlanId,const string &vlanIfName,const UI64 &vlanIfIndex,const UI32 &opCode,const bool &negation);
            virtual    ~NsmUpdateIgmpsVlanLocalConfigMessage ();
...
#endif                                            //NSMUPDATEIGMPSVLANLOCALCONFIGMESSAGE_H
