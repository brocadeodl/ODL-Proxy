...
#ifndef NSMPVLANMAPPINGPHYMESSAGE_H
...
namespace DcmNs
{
    ...
    class NsmPVlanMappingPhyMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            NsmPVlanMappingPhyMessage ();
            NsmPVlanMappingPhyMessage (const string &ifName,const UI32 &primaryVlanId,const UI32Range &secVlanRange, const  UI32 &oper, const UI32 &opcode);
            virtual    ~NsmPVlanMappingPhyMessage ();
