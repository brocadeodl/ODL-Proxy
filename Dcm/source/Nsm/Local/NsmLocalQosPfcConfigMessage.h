...
#ifndef NSMLOCALQOSPFCCONFIGMESSAGE_H
#define NSMLOCALQOSPFCCONFIGMESSAGE_H
...
namespace DcmNs
{
    ...
    class NsmLocalQosPfcConfigMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            NsmLocalQosPfcConfigMessage ();
            NsmLocalQosPfcConfigMessage (const SI32 &pfcFlowControlCos,const SI32 &pfcFlowControlTx,const SI32 &pfcFlowControlRx);
            virtual    ~NsmLocalQosPfcConfigMessage ();
