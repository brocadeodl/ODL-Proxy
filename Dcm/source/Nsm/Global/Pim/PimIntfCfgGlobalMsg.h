...
#ifndef _PIMINTFCFGGLOBALMSG_H_
#define _PIMINTFCFGGLOBALMSG_H_
...
namespace DcmNs
{
    ...
    class PimIntfCfgGlobalMsg : public ManagementInterfaceMessage
    {
        private:
        protected:
