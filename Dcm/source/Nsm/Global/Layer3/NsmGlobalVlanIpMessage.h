...
#ifndef NsmGlobalVlanIpMessage_H
#define NsmGlobalVlanIpMessage_H
...
namespace DcmNs
{
    class NsmGlobalVlanIpMessage : public ManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            NsmGlobalVlanIpMessage ();
            virtual  ~NsmGlobalVlanIpMessage ();
...
#endif  //NsmGlobalVlanIpMessage_H
