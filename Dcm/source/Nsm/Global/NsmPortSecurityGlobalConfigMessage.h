...
#ifndef NSMPORTSECURITYGLOBALCONFIGMESSAGE_H
#define NSMPORTSECURITYGLOBALCONFIGMESSAGE_H
...
namespace DcmNs
{
    ...
    class NsmPortSecurityGlobalConfigMessage : public ManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            NsmPortSecurityGlobalConfigMessage ();
            NsmPortSecurityGlobalConfigMessage (const UI8 &opCode,const UI32 &noAllowedMacs,const UI8 &action,const string &mac);
            virtual    ~NsmPortSecurityGlobalConfigMessage ();
