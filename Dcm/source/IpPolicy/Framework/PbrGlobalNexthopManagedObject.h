...
#ifndef PBRGLOBALNEXTHOPADDRMANAGEDOBJECT_H
#define PBRGLOBALNEXTHOPADDRMANAGEDOBJECT_H 
...
// ************* PbrGlobalNexthopManagedObject ************
    class PbrGlobalNexthopManagedObject : virtual public DcmLocalManagedObject
    {
        private:
        ...
        public:
            PbrGlobalNexthopManagedObject (IpPolicyLocalObjectManager *pIpPolicyLocalObjectManager);
            virtual    ~PbrGlobalNexthopManagedObject ();
