...
#ifndef IPCOMMUNITYEXTACCESSLISTLOCALMANAGEDOBJECT_H_
#define IPCOMMUNITYEXTACCESSLISTLOCALMANAGEDOBJECT_H_
...
class IpCommunityExtAccessListLocalManagedObject : virtual public DcmLocalManagedObject
{
	private:
	...
	public:
		IpCommunityExtAccessListLocalManagedObject (IpPolicyLocalObjectManager *pIpPolicyLocalObjectManager);
		IpCommunityExtAccessListLocalManagedObject (IpPolicyLocalObjectManager *pIpPolicyLocalObjectManager,const string &name,
			const UI32 &seq,
			const UI16 &instance,
			const PolicyAction &action,
			const string &regExpr);
		virtual    ~IpCommunityExtAccessListLocalManagedObject ();
...
#endif /* IPCOMMUNITYEXTACCESSLISTLOCALMANAGEDOBJECT_H_ */
