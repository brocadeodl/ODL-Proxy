...
#ifndef APPMLOCALAPPMPROFILEBULKMESSAGE_H
#define APPMLOCALAPPMPROFILEBULKMESSAGE_H
...
namespace DcmNs
{
    ...
    class APPMLocalAPPMProfileBulkMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            APPMLocalAPPMProfileBulkMessage ();
            APPMLocalAPPMProfileBulkMessage (const UI8 &opCode,const UI8 &cmdCode,const string &profileName,const UI32 &profileId,const bool &isActivated,const bool isAllow, const UI32 &macCount, const vector<string> &profileMacs);
            virtual    ~APPMLocalAPPMProfileBulkMessage ();
