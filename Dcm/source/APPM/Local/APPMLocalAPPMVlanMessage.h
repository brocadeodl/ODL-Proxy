...
#ifndef APPMLOCALAPPMVLANMESSAGE_H
#define APPMLOCALAPPMVLANMESSAGE_H
...
namespace DcmNs
{
    ...
    class APPMLocalAPPMVlanMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            APPMLocalAPPMVlanMessage ();
            APPMLocalAPPMVlanMessage (const UI8 &opCode,const UI8 &cmdCode,const string &profileName,const UI32 &profileId,const bool &swModeFlag,const UI8 &swMode,const bool &isAllowedVlanAll,const bool &isAllowedVlanNone,const UI32 &accessVlan,const UI32Range &vlanRange,const UI32 &vlanClassifierGroupId,const UI32 &vlanClassifierVlan);
            virtual    ~APPMLocalAPPMVlanMessage ();
...
#endif                                            //APPMLOCALAPPMVLANMESSAGE_H
