...
#ifndef APPMLOCALAPPMPROFILEMESSAGE_H
#define APPMLOCALAPPMPROFILEMESSAGE_H
...
namespace DcmNs
{
    ...
    class APPMLocalAPPMProfileMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            APPMLocalAPPMProfileMessage ();
            APPMLocalAPPMProfileMessage (const UI8 &opCode,const UI8 &cmdCode,const string &profileName,const UI32 &profileId,const bool &isActivated,const string &profileMac,const bool isAllow,const bool &isFloodingRestricted);
            virtual    ~APPMLocalAPPMProfileMessage ();
...
#endif                                            //APPMLOCALAPPMPROFILEMESSAGE_H
