...
#ifndef APPMLOCALAPPMSECURITYMESSAGE_H
#define APPMLOCALAPPMSECURITYMESSAGE_H
...
namespace DcmNs
{
    ...
    class APPMLocalAPPMSecurityMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            APPMLocalAPPMSecurityMessage ();
            APPMLocalAPPMSecurityMessage (const UI8 &opCode,const UI8 &cmdCode,const string &profileName,const UI32 &profileId,const string &accessGroup);
            virtual    ~APPMLocalAPPMSecurityMessage ();
