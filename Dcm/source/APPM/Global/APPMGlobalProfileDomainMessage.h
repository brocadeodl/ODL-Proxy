...
#ifndef APPMGLOBALPROFILEDOMAINMESSAGE_H
#define APPMGLOBALPROFILEDOMAINMESSAGE_H
...
namespace DcmNs {
    ...
    class APPMGlobalProfileDomainMessage : public ManagementInterfaceMessage {

        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            APPMGlobalProfileDomainMessage ();
            virtual    ~APPMGlobalProfileDomainMessage ();
...
#endif                                            //APPMGLOBALPROFILEDOMAINMESSAGE_H
