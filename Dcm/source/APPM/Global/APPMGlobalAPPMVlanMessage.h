...
#ifndef APPMGLOBALAPPMVLANMESSAGE_H
#define APPMGLOBALAPPMVLANMESSAGE_H
...
namespace DcmNs
{
    ...
    class APPMGlobalAPPMVlanMessage : public ManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            APPMGlobalAPPMVlanMessage ();
            APPMGlobalAPPMVlanMessage (const UI8 &opCode,const UI8 &cmdCode,const string &profileName,const UI32 &profileId,const bool &swModeFlag,const UI8 &swMode,const bool &isChangeVlanList,const bool &isAllowedVlanAll,const bool &isAllowedVlanNone,const UI32 &accessVlan,const UI32Range &vlanRange,const UI32 &vlanClassifierGroupId,const UI32 &vlanClassifierVlan);
            virtual    ~APPMGlobalAPPMVlanMessage ();
            ...
            UI8 getSwMode()  const;
            void setIsChangeVlanList(const bool &isChangeVlanList);
            bool getIsChangeVlanList()  const;
...
#endif                                            //APPMGLOBALAPPMVLANMESSAGE_H
