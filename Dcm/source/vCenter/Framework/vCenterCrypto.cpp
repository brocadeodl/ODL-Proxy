 ...
 */
unsigned char * vCenterCrypto::base64_decode(unsigned char *src, int *rlen )
{
 ...
 * It allocated the memory.
 */
unsigned char *vCenterCrypto::base64_encode(unsigned char *src, int srclen)
{
	int enclen, padlen;
 ...
 */
string vCenterCrypto::encryptPassword(const string &password)
{
 ...
 */
string vCenterCrypto::decryptPassword(const string &encodedPassword)
{
