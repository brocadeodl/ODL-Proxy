...
#ifndef BGPLOCALAFIPV4UCASTMANAGEDOBJECT_H
#define BGPLOCALAFIPV4UCASTMANAGEDOBJECT_H
...
class BgpLocalAfIpv4UcastManagedObject : virtual public DcmLocalManagedObject ,virtual public BgpLocalAfIpv4CommonAttributesCommonManagedObjectBase ,virtual public BgpLocalAfIpv4UnicastAndVrfCommonManagedObjectBase ,virtual public BgpLocalAfIpv4UcastAndMcastAttributesCommonManagedObjectBase
{
    private   :
    protected :
    ...
    public    :
                                                            BgpLocalAfIpv4UcastManagedObject                        (BgpLocalObjectManager *pBgpLocalObjectManager);
                                                            BgpLocalAfIpv4UcastManagedObject                        (BgpLocalObjectManager *pBgpLocalObjectManager,
                ...
                virtual                                     ~BgpLocalAfIpv4UcastManagedObject                       ();
                void                                        setpresenceFlag                                         (const bool &presenceFlag);
                bool                                        getpresenceFlag                                         ();
                void                                        setnextHopRecursionFlag                                 (const bool &nextHopRecursionFlag);
                bool                                        getnextHopRecursionFlag                                 ();
