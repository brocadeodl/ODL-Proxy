...
#ifndef POLICERCLIENTPOLICYCLASSMAPMESSAGE_H
#define POLICERCLIENTPOLICYCLASSMAPMESSAGE_H
...
namespace DcmNs
{
    ...
    class PolicerClientPolicyClassMapMessage : public DcmManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            PolicerClientPolicyClassMapMessage ();
            PolicerClientPolicyClassMapMessage(const string &policyClassMapName,
			...
			const string &classMapId, const string &priorityClassMapId,
			const UI32 &opcode, const UI8 &cos, const UI8 &trafficClass,
			const UI16 &dscp, const string &CoSMutationMapName,
            ...
            virtual    ~PolicerClientPolicyClassMapMessage ();
...
#endif                                            //POLICERCLIENTPolicyClassMAPMESSAGE_H
