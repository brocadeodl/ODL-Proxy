...
#ifndef APPMPROFILEBULKMESSAGE_H
#define APPMPROFILEBULKMESSAGE_H
...
namespace DcmNs
{
    class APPMProfileBulkMessage : public DcmManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            APPMProfileBulkMessage ();
            APPMProfileBulkMessage (const UI8 &opCode,const UI8 &cmdCode,const string &profileName,const UI32 &profileId,const bool &isActivated,const bool &isAllow,const UI32 &macCount, const vector<string> &profileMacs);
            virtual    ~APPMProfileBulkMessage ();
...
#endif //APPMPROFILEBULKMESSAGE_H
