...
#ifndef APPMSECPROFILEMESSAGE_H
#define APPMSECPROFILEMESSAGE_H
...
namespace DcmNs
{
    ...
    class APPMSecProfileMessage : public DcmManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            APPMSecProfileMessage ();
            APPMSecProfileMessage (const UI8 &opCode,const UI8 &cmdCode,const string &profileName,const UI32 &profileId,const string &accessGroup);
            virtual    ~APPMSecProfileMessage ();
