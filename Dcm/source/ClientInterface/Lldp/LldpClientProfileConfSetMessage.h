...
#ifndef LLDPCLIENTPROFILECONFSETMESSAGE_H
#define LLDPCLIENTPROFILECONFSETMESSAGE_H
...
namespace DcmNs
{
    ...
    class LldpClientProfileConfSetMessage : public DcmManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            LldpClientProfileConfSetMessage ();
            LldpClientProfileConfSetMessage (const UI32 &mgmtFlags,const UI32 &cmdcode,const UI32 &msgType,const string &ProfileName,const string &description,const UI32 &hello,const UI8 &mode,const UI32 &multiplier,const bool &dcbxFcoeAppTlv,const bool &dcbxFcoeLogicalLinkTlv,const bool &dcbxIscsiAppTlv,const bool &dcbxTlv,const bool &dot1xTlv,const bool &dot3xTlv,const bool &mgmtAddrTlv,const bool &portDescrTlv,const bool &sysCapTlv,const bool &sysDescrTlv,const bool &sysNameTlv);
            virtual    ~LldpClientProfileConfSetMessage ();
...
#endif                                            //LLDPCLIENTPROFILECONFSETMESSAGE_H
