...
#ifndef SSMIPACLRULEMESSAGE_H
#define SSMIPACLRULEMESSAGE_H
...
namespace DcmNs
{
    ...
    class SsmIpAclRuleMessage : public DcmManagementInterfaceMessage, public SsmAssocIpRuleToPolicyPayloadMessage
    {
        private:
        protected:
        ...
        public:
            SsmIpAclRuleMessage ();
            SsmIpAclRuleMessage (const string &policyName, const UI32 &policyType,
				...
				const UI32 &customDscp, const string &precedenceUnion, const string &tosUnion,
				const string &dscpUnion, const bool &urg, const bool &ack, const bool &push, 
				const bool &fin, const bool  &rst, const bool &sync, 
				const  UI32 &opcode, const UI8 &userEnteredSeqid);
            virtual    ~SsmIpAclRuleMessage ();
