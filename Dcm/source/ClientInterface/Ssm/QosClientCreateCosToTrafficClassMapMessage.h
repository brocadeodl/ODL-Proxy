...
#ifndef QOSCLIENTCREATECOSTOTRAFFICCLASSMAPMESSAGE_H
#define QOSCLIENTCREATECOSTOTRAFFICCLASSMAPMESSAGE_H
...
namespace DcmNs
{
    ...
    class QosClientCreateCosToTrafficClassMapMessage : public DcmManagementInterfaceMessage 
    {
        private:
        protected:
        ...
        public:
            ...
            virtual    ~QosClientCreateCosToTrafficClassMapMessage ();
...
#endif                                            //QOSCLIENTCREATECOSTOTRAFFICCLASSMAPMESSAGE_H
