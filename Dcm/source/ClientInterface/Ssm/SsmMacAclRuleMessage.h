...
#ifndef SSMMACACLRULEMESSAGE_H
#define SSMMACACLRULEMESSAGE_H
...
namespace DcmNs
{
    ...
    class SsmMacAclRuleMessage : public DcmManagementInterfaceMessage, public SsmAssocRuleToPolicyMsgPayload
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            SsmMacAclRuleMessage ();
            SsmMacAclRuleMessage (const string &policyName, const UI32 &policyType,
