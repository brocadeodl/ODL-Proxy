...
#ifndef SSMMACACLSHOWMESSAGE_H
#define SSMMACACLSHOWMESSAGE_H
...
namespace DcmNs
{
    ...
    class SsmMacAclShowMessage : public DcmManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            SsmMacAclShowMessage ();
            virtual    ~SsmMacAclShowMessage ();
