...
#ifndef QOSCLIENTCREATEQOSRCVQUEUEMULTICASTSETTINGMESSAGE_H
#define QOSCLIENTCREATEQOSRCVQUEUEMULTICASTSETTINGMESSAGE_H
...
namespace DcmNs
{
    ...
    class QosClientCreateQosRcvQueueMulticastSettingMessage : public DcmManagementInterfaceMessage 
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            QosClientCreateQosRcvQueueMulticastSettingMessage ();
            QosClientCreateQosRcvQueueMulticastSettingMessage (const SI32 &rateLimit,const SI32 &burst,const SI32 &thresholdTrafficClass0,const SI32 &thresholdTrafficClass1,const SI32 &thresholdTrafficClass2,const SI32 &thresholdTrafficClass3, const SI32 &thresholdTrafficClass4,const SI32 &thresholdTrafficClass5,const SI32 &thresholdTrafficClass6,const SI32 &thresholdTrafficClass7, const SI32 &opCode);
            virtual    ~QosClientCreateQosRcvQueueMulticastSettingMessage ();
...
#endif                                            //QOSCLIENTCREATEQOSRCVQUEUEMULTICASTSETTINGMESSAGE_H
