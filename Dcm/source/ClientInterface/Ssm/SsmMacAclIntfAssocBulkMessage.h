...
#ifndef SSMMACACLINTFASSOCBULKMESSAGE_H
#define SSMMACACLINTFASSOCBULKMESSAGE_H
...
namespace DcmNs
{
    ...
    class SsmMacAclIntfAssocBulkMessage : public DcmManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            SsmMacAclIntfAssocBulkMessage ();
            virtual    ~SsmMacAclIntfAssocBulkMessage ();
