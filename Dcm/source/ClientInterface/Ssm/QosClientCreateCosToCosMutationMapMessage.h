...
#ifndef QOSCLIENTCREATECOSTOCOSMUTATIONMAPMESSAGE_H
#define QOSCLIENTCREATECOSTOCOSMUTATIONMAPMESSAGE_H
...
namespace DcmNs
{
    ...
    class QosClientCreateCosToCosMutationMapMessage : public DcmManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            QosClientCreateCosToCosMutationMapMessage ();
            QosClientCreateCosToCosMutationMapMessage (const string &cosToCosMutationMapName,const SI32 &cos0MutatedCosValue,const SI32 &cos1MutatedCosValue,const SI32 &cos2MutatedCosValue,const SI32 &cos3MutatedCosValue,const SI32 &cos4MutatedCosValue,const SI32 &cos5MutatedCosValue,const SI32 &cos6MutatedCosValue,const SI32 &cos7MutatedCosValue);
            virtual    ~QosClientCreateCosToCosMutationMapMessage ();
...
#endif                                            //QOSCLIENTCREATECOSTOCOSMUTATIONMAPMESSAGE_H
