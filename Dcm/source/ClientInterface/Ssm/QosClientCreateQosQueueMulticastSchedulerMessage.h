...
#ifndef QOSCLIENTCREATEQOSQUEUEMULTICASTSCHEDULERMESSAGE_H
#define QOSCLIENTCREATEQOSQUEUEMULTICASTSCHEDULERMESSAGE_H
...
namespace DcmNs
{
    ...
    class QosClientCreateQosQueueMulticastSchedulerMessage : public DcmManagementInterfaceMessage 
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            QosClientCreateQosQueueMulticastSchedulerMessage ();
            QosClientCreateQosQueueMulticastSchedulerMessage (const SI32 &dwrrTrafficClass0,const SI32 &dwrrTrafficClass1,const SI32 &dwrrTrafficClass2,const SI32 &dwrrTrafficClass3,const SI32 &dwrrTrafficClass4,const SI32 &dwrrTrafficClass5,const SI32 &dwrrTrafficClass6,const SI32 &dwrrTrafficClass7);
            virtual    ~QosClientCreateQosQueueMulticastSchedulerMessage ();
...
#endif                                            //QOSCLIENTCREATEQOSQUEUEMULTICASTSCHEDULERMESSAGE_H
