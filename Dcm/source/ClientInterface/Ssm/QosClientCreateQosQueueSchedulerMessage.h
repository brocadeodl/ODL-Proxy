...
#ifndef QOSCLIENTCREATEQOSQUEUESCHEDULERMESSAGE_H
#define QOSCLIENTCREATEQOSQUEUESCHEDULERMESSAGE_H
...
namespace DcmNs
{
    ...
    class QosClientCreateQosQueueSchedulerMessage : public  DcmManagementInterfaceMessage 
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            QosClientCreateQosQueueSchedulerMessage ();
            QosClientCreateQosQueueSchedulerMessage (const SI32 &strictPriority,const SI32 &dwrrTrafficClass0,const SI32 &dwrrTrafficClass1,const SI32 &dwrrTrafficClass2,const SI32 &dwrrTrafficClass3,const SI32 &dwrrTrafficClass4,const SI32 &dwrrTrafficClass5,const SI32 &dwrrTrafficClass6,const SI32 &dwrrTrafficClass7);
            virtual    ~QosClientCreateQosQueueSchedulerMessage ();
...
#endif                                            //QOSCLIENTCREATEQOSQUEUESCHEDULERMESSAGE_H
