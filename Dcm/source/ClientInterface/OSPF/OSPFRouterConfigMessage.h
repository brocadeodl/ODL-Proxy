...
#ifndef OSPFROUTERCONFIGMESSAGE_H
#define OSPFROUTERCONFIGMESSAGE_H
...
namespace DcmNs
{
    ...
    class OSPFRouterConfigMessage : public DcmManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            OSPFRouterConfigMessage ();
            virtual    ~OSPFRouterConfigMessage ();
			...
			void setReplayCmdCodeBitmap(const OSPFRouterConfigCmdCode &cmdCode);

			string getVRF() const;
			void setVRF(const string &vrfName);

			void dumpMessage() const;
			void copyFromLocalMessage(OSPFRouterConfigLocalMessage *pMsg);
...
// Now the data members
        ...
        public:
			 ...
			 */
			UI64 m_replayCmdCodeBitmap;
			vector<IpV4Address> m_replayNeighborList;
			vector<IpV4Address> m_replaySummaryAddressList;
			vector<IpV4Address> m_replaySummaryMaskList;
		UI32 m_cmdType;
...
#endif                                            //OSPFROUTERCONFIGMESSAGE_H
