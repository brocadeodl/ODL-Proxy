...
#ifndef DOT1XCLEARMESSAGE_H
#define DOT1XCLEARMESSAGE_H
...
namespace DcmNs
{
    ...
    class Dot1XClearMessage : public DcmManagementInterfaceMessage
    {
        private:
        protected:
        ...
        public:
            Dot1XClearMessage ();
            Dot1XClearMessage (const string &Interface, const string &ifName, const UI32 &cmdCode, const UI32 &mappedId);
            virtual ~Dot1XClearMessage ();
