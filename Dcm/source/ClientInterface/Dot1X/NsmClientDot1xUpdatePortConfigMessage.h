...
#ifndef NSMCLIENTDOTXUPDATEPORTCONFIGMESSAGE_H
#define NSMCLIENTDOTXUPDATEPORTCONFIGMESSAGE_H
...
namespace DcmNs
{
    ...
    class NsmClientDot1xUpdatePortConfigMessage : public DcmManagementInterfaceMessage
    {
        private:
        protected:
        ...
        public:
            ...
            virtual    ~NsmClientDot1xUpdatePortConfigMessage ();
