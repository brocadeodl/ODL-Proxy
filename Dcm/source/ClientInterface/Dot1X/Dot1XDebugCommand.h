...
#ifndef DOT1XDEBUGCOMMAND_H
#define DOT1XDEBUGCOMMAND_H
...
namespace DcmNs
{
    ...
    class Dot1XDebugMessage : public DcmManagementInterfaceMessage
    {
        private:
        protected:
        ...
        public:
            Dot1XDebugMessage ();
            Dot1XDebugMessage (const string &Interface, const string &ifName,const UI32 &cmdType, const UI32 &cmdCode, const UI32 &subCode, const UI32 &mappedId);
            virtual ~Dot1XDebugMessage ();
