...
#ifndef L3ssShowMessage_H
#define L3ssShowMessage_H
...
namespace DcmNs
{
    ...
    class L3ssShowMessage : public DcmManagementInterfaceMessage
    {
        private:
        protected:
