...
#ifndef IGMPSCLIENTUPDATEVLANCONFIGMESSAGE_H
#define IGMPSCLIENTUPDATEVLANCONFIGMESSAGE_H
...
namespace DcmNs
{
    ...
    class IgmpsClientUpdateVlanConfigMessage : public DcmManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            IgmpsClientUpdateVlanConfigMessage ();
            IgmpsClientUpdateVlanConfigMessage (const UI32 &lmqi,const UI32 &qmrt,const bool &enable,const bool &fastLeave,const UI32 &queryInterval,const bool &querierEnable,const UI32 &mrouterTimeout,const UI32 &vlanId,const string &vlanIfName,const UI64 &vlanIfIndex,const UI32 &opCode,const bool &negation);
            virtual    ~IgmpsClientUpdateVlanConfigMessage ();
...
#endif                                            //IGMPSCLIENTUPDATEVLANCONFIGMESSAGE_H
