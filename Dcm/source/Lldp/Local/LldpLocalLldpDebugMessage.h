...
#ifndef LLDPLOCALLLDPDEBUGMESSAGE_H
#define LLDPLOCALLLDPDEBUGMESSAGE_H
...
namespace DcmNs
{
    ...
    class LldpLocalLldpDebugMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            LldpLocalLldpDebugMessage ();
            LldpLocalLldpDebugMessage (const string &ifName,
                                       const UI32 &cmdCode, 
                                       const UI32 &dbgFlags,
                                       const UI32 &lastIfIndex,
                                       const UI32 &numRecords,
                                       bool isGwRequest);
            virtual    ~LldpLocalLldpDebugMessage ();
...
#endif                                            //LLDPLOCALLLDPDEBUGMESSAGE_H
