...
#ifndef LLDPGLOBALSCALARSCONFSETMESSAGE_H
#define LLDPGLOBALSCALARSCONFSETMESSAGE_H
...
namespace DcmNs
{
    ...
    class LldpGlobalScalarsConfSetMessage : public ManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            LldpGlobalScalarsConfSetMessage ();
            LldpGlobalScalarsConfSetMessage (const UI32 &mgmtFlags,const UI32 &cmdcode,const UI32 &msgType,const string &description,const UI32 &hello,const UI32 &mode,const UI32 &multiplier,const bool &dcbxFcoeAppTlv,const bool &dcbxFcoeLogicalLinkTlv,const bool &dcbxIscsiAppTlv,const UI32 &iscsiPriority, const bool &dcbxTlv,const bool &dot1xTlv,const bool &dot3xTlv,const bool &mgmtAddrTlv,const bool &portDescrTlv,const bool &sysCapTlv,const bool &sysDescrTlv,const bool &sysNameTlv,const string &sysName,const string &sysDescr,const bool &disable);
            virtual    ~LldpGlobalScalarsConfSetMessage ();
...
#endif                                            //LLDPGLOBALSCALARSCONFSETMESSAGE_H
