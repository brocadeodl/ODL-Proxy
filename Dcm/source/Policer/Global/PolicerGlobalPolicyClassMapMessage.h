...
#ifndef POLICERGLOBALPOLICYCLASSMAPMESSAGE_H
#define POLICERGLOBALPOLICYCLASSMAPMESSAGE_H
...
namespace DcmNs
{
    ...
    class PolicerGlobalPolicyClassMapMessage : public ManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            PolicerGlobalPolicyClassMapMessage ();
            PolicerGlobalPolicyClassMapMessage(const string &policyClassMapName,
            ...
            virtual    ~PolicerGlobalPolicyClassMapMessage ();
            ...
            void setsSlowMapName( const string &sflowMapName);
...
#endif                                            //POLICERGLOBALPOLICYCLASSMAPMESSAGE_H
