...
#ifndef SSMLOCALSERVICEASSOCIPRULETOPOLICYMESSAGE_H
#define SSMLOCALSERVICEASSOCIPRULETOPOLICYMESSAGE_H
...
namespace DcmNs
{
    ...
    class SsmLocalServiceAssocIpRuleToPolicyMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            SsmLocalServiceAssocIpRuleToPolicyMessage ();
            SsmLocalServiceAssocIpRuleToPolicyMessage (
			...
			virtual	~SsmLocalServiceAssocIpRuleToPolicyMessage ();
...
#endif                                            //SSMLOCALSERVICEASSOCIPRULETOPOLICYMESSAGE_H
