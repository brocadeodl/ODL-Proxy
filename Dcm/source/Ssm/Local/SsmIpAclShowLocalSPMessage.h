...
#ifndef SSMIPACLSHOWLOCALMESSAGE_H
#define SSMIPACLSHOWLOCALMESSAGE_H
...
namespace DcmNs
{
    class SsmIpAclShowLocalSPMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            SsmIpAclShowLocalSPMessage ();
            SsmIpAclShowLocalSPMessage (const string &ifname, const UI32 &binding, const UI32 &detail, const UI32 &iftype, const UI32 &opcode, bool isGwRequest);
            virtual    ~SsmIpAclShowLocalSPMessage ();
