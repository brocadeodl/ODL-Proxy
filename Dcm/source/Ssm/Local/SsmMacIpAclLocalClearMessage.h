...
#ifndef SSMMACIPACLLOCALCLEARMESSAGE_H
#define SSMMACIPACLLOCALCLEARMESSAGE_H
...
namespace DcmNs
{
    class SsmMacIpAclLocalClearMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            SsmMacIpAclLocalClearMessage ();
            SsmMacIpAclLocalClearMessage (const string &PolicyName, const string &ifName, const UI32 &opCode, 
            ...
            virtual     ~SsmMacIpAclLocalClearMessage ();
...
#endif                                            //SSMMACIPACLLOCALCLEARMESSAGE_H
