...
#ifndef STORMCONTROLLOCALSHOWMESSAGE_H
#define STORMCONTROLLOCALSHOWMESSAGE_H
...
namespace DcmNs
{
    class StormControlLocalShowMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            StormControlLocalShowMessage ();
            StormControlLocalShowMessage (const string &ifName, const UI32 &opCode, 
				bool isGwRequest, const UI32 &ifType, const UI32 &protocol, const UI32 &locationId);
            virtual     ~StormControlLocalShowMessage ();
...
#endif                                            //STORMCONTROLLOCALSHOWMESSAGE_H
