...
#ifndef EXTIPACLRULEMANAGEDOBJECT_H
#define EXTIPACLRULEMANAGEDOBJECT_H
...
namespace DcmNs
{
    ...
    class ExtIpAclRuleManagedObject : virtual public IpAclRuleManagedObject
    {
        ...
        public:
            ExtIpAclRuleManagedObject (SsmGlobalObjectManager *pSsmGlobalObjectManager);
    		ExtIpAclRuleManagedObject (SsmGlobalObjectManager *pSsmGlobalObjectManager,
...
#endif                                            //EXTIPACLRULEMANAGEDOBJECT_H
