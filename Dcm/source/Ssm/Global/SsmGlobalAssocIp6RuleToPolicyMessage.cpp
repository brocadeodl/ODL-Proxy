...
namespace DcmNs
{
    ...
    SsmGlobalAssocIp6RuleToPolicyMessage::SsmGlobalAssocIp6RuleToPolicyMessage ()
        : ManagementInterfaceMessage (SsmGlobalObjectManager::getClassName (),SSMGLOBALASSOCIP6RULETOPOLICY),
          SsmAssocIp6RuleToPolicyPayloadMessage(this)
    {
    }


	SsmGlobalAssocIp6RuleToPolicyMessage::SsmGlobalAssocIp6RuleToPolicyMessage( const string &policyName,
		const UI32 &policyType, const UI64 &ruleid, const UI32 &action, const string &srcUnion, 
		const IpAddrType &srcType, const IpV6Address &srcHostIpAddress, const IpV6AddressNetworkMask &srcIpAddress, 
		const IpV6Address &srcIpAddressMask, const bool &isCount, const bool &isLog, const IpV6Address  
		&dstHostIpAddress, const IpV6AddressNetworkMask &dstIpAddress, const IpV6Address &dstIpAddressMask, const 
		...
		: ManagementInterfaceMessage (SsmGlobalObjectManager::getClassName (),SSMGLOBALASSOCIP6RULETOPOLICY),
		  SsmAssocIp6RuleToPolicyPayloadMessage(this, policyName, policyType, ruleid, action, srcUnion, 
    ...
    void  SsmGlobalAssocIp6RuleToPolicyMessage::setupAttributesForSerialization()
    {
        ManagementInterfaceMessage::setupAttributesForSerialization ();
		SsmAssocIp6RuleToPolicyPayloadMessage::setupAttributesForSerialization ();
    }
