...
#ifndef SsmGlobalAssocIp6RuleToPolicyMessage_H
#define SsmGlobalAssocIp6RuleToPolicyMessage_H
...
namespace DcmNs
{
    ...
    class SsmGlobalAssocIp6RuleToPolicyMessage : public ManagementInterfaceMessage, public SsmAssocIp6RuleToPolicyPayloadMessage 
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            SsmGlobalAssocIp6RuleToPolicyMessage ();
			
			SsmGlobalAssocIp6RuleToPolicyMessage(const string &policyName, const UI32 &policyType, 
				const UI64 &ruleid, const UI32 &action, const string &srcUnion,
				const IpAddrType &srcType, const IpV6Address &srcHostIpAddress, 
				const IpV6AddressNetworkMask &srcIpAddress, const IpV6Address &srcIpAddressMask, 
				const bool &isCount, const bool &isLog, const IpV6Address &dstHostIpAddress, 
				const IpV6AddressNetworkMask &dstIpAddress, const IpV6Address &dstIpAddressMask, const
			...
			virtual	~SsmGlobalAssocIp6RuleToPolicyMessage ();
...
#endif  //SsmGlobalAssocIp6RuleToPolicyMessage_H                                           
