...
#ifndef MACACLRULECONFIGURATIONHANDLER_H 
#define MACACLRULECONFIGURATIONHANDLER_H
...
class MacAclRuleConfigurationHandler : public WaveConfigurationSegmentWorker
{
    private :
    protected :
    public :
                        MacAclRuleConfigurationHandler  (WaveObjectManager *pWaveObjectManager);
        virtual        ~MacAclRuleConfigurationHandler  ();

        //static  string   getWyserEaConfigurationName            ();
    ...
    private :
        int static convertToMacStringFormat(string mac, char *output, UI32 outputSize);
...
#endif //  MACACLRULECONFIGURATIONHANDLER_H
