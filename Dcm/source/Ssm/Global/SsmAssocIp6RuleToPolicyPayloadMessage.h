...
#ifndef SSMASSOCIP6RULETOPOLICYPAYLOADMESSAGE_H
#define SSMASSOCIP6RULETOPOLICYPAYLOADMESSAGE_H
...
namespace DcmNs
{
	...
	class SsmAssocIp6RuleToPolicyPayloadMessage : public WaveMessagePayloadBase 
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            SsmAssocIp6RuleToPolicyPayloadMessage (PrismMessage *pPrismMsg);
			...
			virtual	~SsmAssocIp6RuleToPolicyPayloadMessage ();
...
#endif                                            //SsmAssocIp6RuleToPolicyPayloadMessage_H
