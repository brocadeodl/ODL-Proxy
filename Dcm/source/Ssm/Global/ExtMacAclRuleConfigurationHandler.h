...
#ifndef EXTMACACLRULECONFIGURATIONHANDLER_H
#define EXTMACACLRULECONFIGURATIONHANDLER_H
...
class ExtMacAclRuleConfigurationHandler : public WaveConfigurationSegmentWorker
{
    private :
    protected :
    public :
                        ExtMacAclRuleConfigurationHandler  (WaveObjectManager *pWaveObjectManager);
        virtual        ~ExtMacAclRuleConfigurationHandler  ();
...
#endif // EXTMACACLRULECONFIGURATIONHANDLER_H
