...
#ifndef RMONGLOBALCREATERMONALARMMESSAGE_H
#define RMONGLOBALCREATERMONALARMMESSAGE_H
...
namespace DcmNs
{
    ...
    class RmonGlobalCreateRmonAlarmMessage : public ManagementInterfaceMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            RmonGlobalCreateRmonAlarmMessage ();
            RmonGlobalCreateRmonAlarmMessage (const SI32 &alarmIndex,const string &snmpOid,const UI32 &interval,const UI32 &sampleType,const UI32 &risingThreshold,const SI32 &risingEventId,const UI32 &fallingThreshold,const SI32 &fallingEventId,const string &owner);
            virtual    ~RmonGlobalCreateRmonAlarmMessage ();
...
#endif                                            //RMONGLOBALCREATERMONALARMMESSAGE_H
