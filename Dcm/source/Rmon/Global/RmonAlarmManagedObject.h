...
#ifndef RMONALARMMANAGEDOBJECT_H
#define RMONALARMMANAGEDOBJECT_H
...
namespace DcmNs
{
    ...
    class RmonAlarmManagedObject : virtual public DcmManagedObject
    {
        private:
        protected:
        ...
        public:
            RmonAlarmManagedObject (RmonGlobalObjectManager *pRmonGlobalObjectManager);
            RmonAlarmManagedObject (RmonGlobalObjectManager *pRmonGlobalObjectManager,const SI32 &alarmIndex,const string &snmpOid,const UI32 &interval,const UI32 &sampleType,const UI32 &risingThreshold,const SI32 &risingEventId,const UI32 &fallingThreshold,const SI32 &fallingEventId,const string &owner, const string &ifName, const SI32 &statsIndex);
            virtual    ~RmonAlarmManagedObject ();
...
#endif                                            //RMONALARMMANAGEDOBJECT_H
