...
#ifndef RMONCREATERMONALARMSPMESSAGE_H
#define RMONCREATERMONALARMSPMESSAGE_H
...
namespace DcmNs
{
    ...
    class RmonCreateRmonAlarmSPMessage : public PrismMessage 
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            RmonCreateRmonAlarmSPMessage ();
            RmonCreateRmonAlarmSPMessage (const SI32 &alarmIndex,const string &snmpOid,const UI32 &interval,const UI32 &sampleType,const UI32 &risingThreshold,const SI32 &risingEventId,const UI32 &fallingThreshold,const SI32 &fallingEventId,const string &owner);
            virtual    ~RmonCreateRmonAlarmSPMessage ();
...
#endif                                            //RMONCREATERMONALARMSPMESSAGE_H
