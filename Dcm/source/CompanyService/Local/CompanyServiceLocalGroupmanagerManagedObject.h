...
#ifndef COMPANYSERVICELOCALGROUPMANAGERMANAGEDOBJECT_H
#define COMPANYSERVICELOCALGROUPMANAGERMANAGEDOBJECT_H
...
class CompanyServiceLocalGroupmanagerManagedObject : virtual public DcmLocalManagedObject
{
    private   :
    protected :
    ...
    public    :
                                                            CompanyServiceLocalGroupmanagerManagedObject            (CompanyServiceLocalObjectManager *pCompanyServiceLocalObjectManager);
                                                            CompanyServiceLocalGroupmanagerManagedObject            (CompanyServiceLocalObjectManager *pCompanyServiceLocalObjectManager,
                ...
                virtual                                     ~CompanyServiceLocalGroupmanagerManagedObject           ();
                void                                        setgroupmanagername                                     (const string &groupmanagername);
                string                                      getgroupmanagername                                     ();
    private   :
    protected :
    public    :
        string                                          m_groupmanagername;
};
