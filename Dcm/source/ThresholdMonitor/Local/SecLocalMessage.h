...
/************************************************************************
  ...
  ***********************************************************************/
#ifndef  SECLOCALMESSAGE_H
#define  SECLOCALMESSAGE_H
...
namespace DcmNs
{
	class SecLocalMessage  : public PrismMessage
	{
		private:
		protected:
		...
		public:
			SecLocalMessage ();
			SecLocalMessage  (const string &policy, const UI32 &area, const UI32 &timebase,
			...
			virtual ~SecLocalMessage ();
			void setPolicyName(const string &policy);
			string getPolicyName() const;
			void setAreaName(const UI32 &area);
