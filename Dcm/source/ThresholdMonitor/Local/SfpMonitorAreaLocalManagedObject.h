...
#ifndef SFPMONITORAREALOCALMANAGEDOBJECT_H
#define SFPMONITORAREALOCALMANAGEDOBJECT_H
...
namespace DcmNs
{
	...
	class SfpMonitorAreaLocalManagedObject : virtual public DcmLocalManagedObject
	{
		private:
		protected:
		...
		public:
			SfpMonitorAreaLocalManagedObject (ThresholdMonitorLocalObjectManager *pThresholdMonitorLocalObjectManager);
			SfpMonitorAreaLocalManagedObject
			...
			virtual    ~SfpMonitorAreaLocalManagedObject();
			static string getClassName();
			void setSfptypeName(const UI32 &sfptypename, bool userConfig);
...
#endif															//SFPMONITORAREALOCALMANAGEDOBJECT_H
