...
#ifndef INTERFACEGLOBALSHOWMESSAGE_H
#define INTERFACEGLOBALSHOWMESSAGE_H
...
namespace DcmNs
{
	class InterfaceGlobalShowMessage : public PrismMessage
	{
		private:
		protected:
			virtual void setupAttributesForSerialization();
		public:
			InterfaceGlobalShowMessage ();
			InterfaceGlobalShowMessage (const UI32 &areaName, const string &ifName);
			virtual ~InterfaceGlobalShowMessage ();
