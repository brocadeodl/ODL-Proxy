...
#ifndef IPADMMESSAGECONTEXT
#define IPADMMESSAGECONTEXT
...
class IpadmMessagingContext : public PrismLinearSequencerContext
{
    private :
    protected :
    public :
       IpadmMessagingContext (PrismMessage *pPrismMessage, PrismElement *pPrismElement, PrismLinearSequencerStep *pSteps, UI32 numberOfSteps);

       ~IpadmMessagingContext ();
