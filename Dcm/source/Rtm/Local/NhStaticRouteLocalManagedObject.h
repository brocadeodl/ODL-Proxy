...
#ifndef NHSTATICROUTELOCALMANAGEDOBJECT_H
#define NHSTATICROUTELOCALMANAGEDOBJECT_H
...
namespace DcmNs
{
    ...
    class NhStaticRouteLocalManagedObject : virtual public DcmLocalManagedObject
    {
        private:
        protected:
        ...
        public:
            NhStaticRouteLocalManagedObject (RtmLocalObjectManager *pRtmLocalObjectManager);
            virtual    ~NhStaticRouteLocalManagedObject ();
