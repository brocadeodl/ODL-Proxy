...
#ifndef IFSTATICROUTELOCALMANAGEDOBJECT_H
#define IFSTATICROUTELOCALMANAGEDOBJECT_H
...
namespace DcmNs
{
    ...
    class IfStaticRouteLocalManagedObject : virtual public DcmLocalManagedObject
    {
        private:
        protected:
        ...
        public:
            IfStaticRouteLocalManagedObject (RtmLocalObjectManager *pRtmLocalObjectManager);
            virtual    ~IfStaticRouteLocalManagedObject ();
...
#endif                                            //IFSTATICROUTELOCALMANAGEDOBJECT_H
