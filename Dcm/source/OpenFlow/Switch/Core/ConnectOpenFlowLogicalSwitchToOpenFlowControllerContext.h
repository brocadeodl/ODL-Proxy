...
#ifndef CONNECTOPENFLOWLOGICALSWITCHTOOPENFLOWCONTROLLERCONTEXT_H
#define CONNECTOPENFLOWLOGICALSWITCHTOOPENFLOWCONTROLLERCONTEXT_H
...
class ConnectOpenFlowLogicalSwitchToOpenFlowControllerContext : public PrismLinearSequencerContext
{
    private :
    protected :
    public :
                                            ConnectOpenFlowLogicalSwitchToOpenFlowControllerContext (PrismMessage *pPrismMessage, PrismElement *pPrismElement, PrismLinearSequencerStep *pSteps, UI32 numberOfSteps);
                                            ConnectOpenFlowLogicalSwitchToOpenFlowControllerContext (PrismAsynchronousContext *pPrismAsynchronousContext, PrismElement *pPrismElement, PrismLinearSequencerStep *pSteps, UI32 numberOfSteps);
                                           ~ConnectOpenFlowLogicalSwitchToOpenFlowControllerContext ();
...
#endif // CONNECTOPENFLOWLOGICALSWITCHTOOPENFLOWCONTROLLERCONTEXT_H
