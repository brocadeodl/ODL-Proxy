...
#ifndef OPENFLOWSWITCHOBJECTMANAGERCONNECTOPENFLOWLOGICALSWITCHTOOPENFLOWCONTROLLERMESSAGE_H
#define OPENFLOWSWITCHOBJECTMANAGERCONNECTOPENFLOWLOGICALSWITCHTOOPENFLOWCONTROLLERMESSAGE_H
...
class OpenFlowSwitchObjectManagerConnectOpenFlowLogicalSwitchToOpenFlowControllerMessage : public ManagementInterfaceMessage
{
    private :
    ...
    protected :
    public :
                                                   OpenFlowSwitchObjectManagerConnectOpenFlowLogicalSwitchToOpenFlowControllerMessage ();
        virtual                                   ~OpenFlowSwitchObjectManagerConnectOpenFlowLogicalSwitchToOpenFlowControllerMessage ();
...
#endif // OPENFLOWSWITCHOBJECTMANAGERCONNECTOPENFLOWLOGICALSWITCHTOOPENFLOWCONTROLLERMESSAGE_H
