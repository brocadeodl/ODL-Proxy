...
#ifndef NSPNETWORKINTERFACESWAVESERVERMULTIPAGEFORRESTXML_H
#define NSPNETWORKINTERFACESWAVESERVERMULTIPAGEFORRESTXML_H
...
class NspNetworkInterfacesWaveServerMultiPageForRestXml : public WaveServerMultiPage
{
    private :
    ...
    protected :
    public :
                 NspNetworkInterfacesWaveServerMultiPageForRestXml (HttpInterfaceReceiverObjectManager* pHttpInterfaceReceiverObjectManager, const string& path);
        virtual ~NspNetworkInterfacesWaveServerMultiPageForRestXml ();
...
#endif // NSPNETWORKINTERFACESWAVESERVERMULTIPAGEFORRESTXML_H
