...
#ifndef AAALocalAssocIpRuleToPolicyMessage_H
#define AAALocalAssocIpRuleToPolicyMessage_H
...
namespace DcmNs
{
    ...
    class AAALocalAssocIpRuleToPolicyMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            AAALocalAssocIpRuleToPolicyMessage ();
            AAALocalAssocIpRuleToPolicyMessage (
			...
			virtual	~AAALocalAssocIpRuleToPolicyMessage ();
...
#endif                                            //AAALocalAssocIpRuleToPolicyMessage_H
