...
#ifndef AAALocalAssocIp6RuleToPolicyMessage_H
#define AAALocalAssocIp6RuleToPolicyMessage_H
...
namespace DcmNs
{
    ...
    class AAALocalAssocIp6RuleToPolicyMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            AAALocalAssocIp6RuleToPolicyMessage ();
            AAALocalAssocIp6RuleToPolicyMessage (
...
// const IpV6Address &dstIpAddressMask,
			...
			virtual	~AAALocalAssocIp6RuleToPolicyMessage ();
...
#endif                                            //AAALocalAssocIp6RuleToPolicyMessage_H
