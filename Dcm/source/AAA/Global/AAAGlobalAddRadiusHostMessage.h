...
#ifndef AAAGLOBALADDRADIUSHOSTMESSAGE_H
#define AAAGLOBALADDRADIUSHOSTMESSAGE_H
...
class AAAGlobalAddRadiusHostMessage : public PrismMessage
{
  protected:
	virtual void setupAttributesForSerialization();
  public:
	AAAGlobalAddRadiusHostMessage ();
	AAAGlobalAddRadiusHostMessage (const string &host,const SI32 &port,const AuthProtocol &protocol,const string &key,const SI32 &retransmit, const SI32 &timeout, const bool &portF, const bool &protocolF, const bool &retransmitF);
	virtual    ~AAAGlobalAddRadiusHostMessage ();
...
#endif                                            //AAAGLOBALADDRADIUSHOSTMESSAGE_H
