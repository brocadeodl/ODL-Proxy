...
#ifndef AAAGLOBALGETACTIVEUSERSMESSAGE_H
#define AAAGLOBALGETACTIVEUSERSMESSAGE_H
...
namespace DcmNs
{
	...
	class AAAGlobalGetActiveUsersMessage : public PrismMessage
	{
		private:
		protected:
			virtual void setupAttributesForSerialization();
		public:
			AAAGlobalGetActiveUsersMessage ();
			AAAGlobalGetActiveUsersMessage (const vector<string> &userName,
			...
			virtual ~AAAGlobalGetActiveUsersMessage ();
			...
			void setActiveUser(const string &userName, const string &hostName,
				...
				const DateTime &timeOfLog, const UI32 &switchid,
				const string &role);
...
#endif      //AAAGLOBALGETACTIVEUSERSMESSAGE_H
