...
#ifndef AAAGLOBALADDRULEMESSAGE_H
#define AAAGLOBALADDRULEMESSAGE_H
...
namespace DcmNs
{
    ...
    class AAAGlobalAddRuleMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            AAAGlobalAddRuleMessage ();
            AAAGlobalAddRuleMessage (const UI32 &index, const vector<string> &command, const vector<string> &keypath, const string &context, const SI32 &commandEnum, const string &instanceCommand, const RBACCommandType &commandType,const string &role,const RBACOperation &operation,const RBACAction &action);
            virtual    ~AAAGlobalAddRuleMessage ();
...
#endif                                            //AAAGLOBALADDRULEMESSAGE_H
