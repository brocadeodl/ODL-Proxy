...
#ifndef SPANLOCALSPANLOCALCONFIGMESSAGE_H
#define SPANLOCALSPANLOCALCONFIGMESSAGE_H
...
namespace DcmNs
{
    ...
    class SpanLocalSpanLocalConfigMessage : public PrismMessage
    {
        private:
        protected:
            virtual void setupAttributesForSerialization();
        public:
            SpanLocalSpanLocalConfigMessage ();
            SpanLocalSpanLocalConfigMessage (const UI32 &session_id,const string &source_ifName,const string &dest_ifName,const UI32 &direction,const UI32 &opCode,const UI32 &messageType,const string &description, const UI32 &src_ethernet, const UI32 &dest_ethernet, const UI32 &trill_sa, const UI32 &trill_da);
            virtual    ~SpanLocalSpanLocalConfigMessage ();
			...
			void copyBufferFromClient(SpanClientLocalSpanLocalConfigMessage *m);
...
#endif                                            //SPANLOCALSPANLOCALCONFIGMESSAGE_H
