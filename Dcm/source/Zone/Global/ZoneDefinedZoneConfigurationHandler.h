...
#ifndef ZONEDEFINEDZONECONFIGURATIONHANDLER_H 
#define ZONEDEFINEDZONECONFIGURATIONHANDLER_H
...
class ZoneDefinedZoneConfigurationHandler : public WaveConfigurationSegmentWorker
{
    private :
    protected :
    public :
                        ZoneDefinedZoneConfigurationHandler (WaveObjectManager *pWaveObjectManager);
        virtual        ~ZoneDefinedZoneConfigurationHandler ();
