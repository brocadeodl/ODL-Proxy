...
#ifndef ZONEDEFINEDCFGCONFIGURATIONHANDLER_H 
#define ZONEDEFINEDCFGCONFIGURATIONHANDLER_H
...
class ZoneDefinedCfgConfigurationHandler : public WaveConfigurationSegmentWorker
{
    private :
    protected :
    public :
                        ZoneDefinedCfgConfigurationHandler (WaveObjectManager *pWaveObjectManager);
        virtual        ~ZoneDefinedCfgConfigurationHandler ();
