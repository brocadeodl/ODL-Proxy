...
#ifndef ZONEDEFINEDZONEMEMBERCONFIGURATIONHANDLER_H 
#define ZONEDEFINEDZONEMEMBERCONFIGURATIONHANDLER_H
...
class ZoneDefinedZoneMemberConfigurationHandler : public WaveConfigurationSegmentWorker
{
    private :
    protected :
    public :
                        ZoneDefinedZoneMemberConfigurationHandler (WaveObjectManager *pWaveObjectManager);
        virtual        ~ZoneDefinedZoneMemberConfigurationHandler ();
