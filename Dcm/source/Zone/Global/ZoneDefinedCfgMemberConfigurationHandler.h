...
#ifndef ZONEDEFINEDCFGMEMBERCONFIGURATIONHANDLER_H 
#define ZONEDEFINEDCFGMEMBERCONFIGURATIONHANDLER_H
...
class ZoneDefinedCfgMemberConfigurationHandler : public WaveConfigurationSegmentWorker
{
    private :
    protected :
    public :
                        ZoneDefinedCfgMemberConfigurationHandler (WaveObjectManager *pWaveObjectManager);
        virtual        ~ZoneDefinedCfgMemberConfigurationHandler ();
