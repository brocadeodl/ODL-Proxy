...
#ifndef ZONEDEFINEDALIASCONFIGURATIONHANDLER_H 
#define ZONEDEFINEDALIASCONFIGURATIONHANDLER_H
...
class ZoneDefinedAliasConfigurationHandler : public WaveConfigurationSegmentWorker
{
    private :
    protected :
    public :
                        ZoneDefinedAliasConfigurationHandler (WaveObjectManager *pWaveObjectManager);
        virtual        ~ZoneDefinedAliasConfigurationHandler ();
