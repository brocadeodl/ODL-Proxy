...
#ifndef ZONEDEFINEDALIASMEMBERCONFIGURATIONHANDLER_H 
#define ZONEDEFINEDALIASMEMBERCONFIGURATIONHANDLER_H
...
class ZoneDefinedAliasMemberConfigurationHandler : public WaveConfigurationSegmentWorker
{
    private :
    protected :
    public :
                        ZoneDefinedAliasMemberConfigurationHandler (WaveObjectManager *pWaveObjectManager);
        virtual        ~ZoneDefinedAliasMemberConfigurationHandler ();
