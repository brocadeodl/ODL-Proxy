...
{
    addPersistableAttributeForCommonBase (new AttributeUI32 (&m_remoteAs, 0, "remoteAs",bgp_remote_as));
    ...
    addPersistableAttributeForCommonBase (new AttributeUI32 (&m_localAs, 0, "localAs",bgp_local_as_value));
...
{
    addPersistableAttributeForCommonBaseCreate (new AttributeUI32 (&m_remoteAs, 0, "remoteAs",bgp_remote_as));
    ...
    addPersistableAttributeForCommonBaseCreate (new AttributeUI32 (&m_localAs, 0, "localAs",bgp_local_as_value));
...
/**@uBreezeFunction: Description of the function
 * Brief:BgpLocalNeighborAttributesCommonManagedObjectBase::setremoteAs:This function is used to set the value of member m_remoteAs
 * @uBreezeClose
 */
void BgpLocalNeighborAttributesCommonManagedObjectBase::setremoteAs (const UI32 &remoteAs)
{
    m_remoteAs = remoteAs;
}
...
/**@uBreezeFunction: Description of the function
 * Brief:BgpLocalNeighborAttributesCommonManagedObjectBase::getremoteAs:This function is used to get the value of member m_remoteAs
 * @uBreezeClose
 */
UI32 BgpLocalNeighborAttributesCommonManagedObjectBase::getremoteAs ()
{
    return (m_remoteAs);
}
...
/**@uBreezeFunction: Description of the function
 * Brief:BgpLocalNeighborAttributesCommonManagedObjectBase::setlocalAs:This function is used to set the value of member m_localAs
 * @uBreezeClose
 */
void BgpLocalNeighborAttributesCommonManagedObjectBase::setlocalAs (const UI32 &localAs)
{
    m_localAs = localAs;
}
...
/**@uBreezeFunction: Description of the function
 * Brief:BgpLocalNeighborAttributesCommonManagedObjectBase::getlocalAs:This function is used to get the value of member m_localAs
 * @uBreezeClose
 */
UI32 BgpLocalNeighborAttributesCommonManagedObjectBase::getlocalAs ()
{
    return (m_localAs);
}
