...
void BgpLocalBasicConfigManagedObject:: setupAttributesForPersistence ()
{
    ...
    addPersistableAttribute (new AttributeUI32 (&m_localAs, 0, "localAs",bgp_local_as));
...
void BgpLocalBasicConfigManagedObject:: setupAttributesForCreate ()
{
    ...
    addPersistableAttributeForCreate (new AttributeUI32 (&m_localAs, 0, "localAs",bgp_local_as));
...
/**@uBreezeFunction: Description of the function
 * Brief:BgpLocalBasicConfigManagedObject::setlocalAs:This function is used to set the value of member m_localAs
 * @uBreezeClose
 */
void BgpLocalBasicConfigManagedObject::setlocalAs (const UI32 &localAs)
{
    m_localAs = localAs;
}
...
/**@uBreezeFunction: Description of the function
 * Brief:BgpLocalBasicConfigManagedObject::getlocalAs:This function is used to get the value of member m_localAs
 * @uBreezeClose
 */
UI32 BgpLocalBasicConfigManagedObject::getlocalAs ()
{
    return (m_localAs);
}
